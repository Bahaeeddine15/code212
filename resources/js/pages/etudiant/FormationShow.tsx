    ...
    <>
      ...
      <AppShell variant="sidebar">
        <div className="flex w-full min-h-screen">
          ...
          <AppContent variant="sidebar" className="flex-1 bg-white dark:bg-gray-900 font-[Poppins] lg:ml-0">
            <div className="p-3 sm:p-4 lg:p-6 pt-4 sm:pt-6">
              ...
              <div className="mb-4 sm:mb-6">
                <Link
                  href="/formations"
                  className="inline-flex items-center px-3 sm:px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-200 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors text-sm sm:text-base"
                >
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
                ...
                <div className="p-4 sm:p-6 md:p-8">
                  ...
                  <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                    <span className="bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-medium">
                      {formation.category}
                    </span>
                    <span className="bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-medium">
                      🏆 Certification
                    </span>
                    <span className="bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-medium">
                  ...
                  {formation.isSignedUp && totalModules > 0 && (
                    <div className="mb-6 sm:mb-8 p-3 sm:p-4 bg-gradient-to-r from-blue-50 to-green-50 dark:from-blue-900/20 dark:to-green-900/20 rounded-lg border border-blue-200 dark:border-blue-700">
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-4 mb-3">
                        <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white">📈 Votre progression</h3>
                        <span className="text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-300 bg-white dark:bg-gray-700 px-2 sm:px-3 py-1 rounded-full">
                  ...
                  <div className="flex flex-col gap-3 sm:flex-row sm:gap-4 mb-6 sm:mb-8">
                    {!formation.isSignedUp ? (
                      ...
                      <div className="flex-1 px-6 sm:px-8 py-3 rounded-lg bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-300 font-medium flex items-center justify-center text-sm sm:text-base">
                         Vous êtes inscrit(e)
                      </div>
                    )}
                    <Link
                      href="/formations"
                      className="flex-1 px-6 sm:px-8 py-3 bg-gray-200 dark:bg-gray-700 text-center text-gray-700 dark:text-gray-200 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors font-medium text-sm sm:text-base"
                    >
                      ← Retour à la liste
                    </Link>
                  </div>
                  ...
                  <div className="mt-8 sm:mt-10 pt-4 sm:pt-6 border-t border-gray-200 dark:border-gray-700">
                    <h2 className="text-xl sm:text-2xl font-semibold mb-4 text-gray-900 dark:text-white"> Modules</h2>
                              ...
                              <div className="flex flex-col lg:flex-row lg:items-start gap-3 sm:gap-4">
                                <div className="flex-1">
                                  <div className="flex flex-col sm:flex-row sm:items-center gap-2 mb-2">
                                    ...
                                    {isCompleted && (
                                      <span className="px-2 py-1 bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-200 rounded-full text-xs font-medium inline-flex items-center gap-1 w-fit">
                                  ...
                                  {m.assets && m.assets.length > 0 ? (
                                    <ul className="mt-3 space-y-2">
                                      {m.assets.map((a) => {
                                        ...
                                        return (
                                          <li key={a.id} className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-3 p-2 bg-gray-50 dark:bg-gray-600/50 rounded-lg">
                                            <div className="flex items-center gap-2 flex-1 min-w-0">
                                              <span className="text-xs sm:text-sm px-2 py-1 rounded bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 whitespace-nowrap">
                                                {typeBadge(a.type)}
                                              </span>
                                            ...
                                            {!locked ? (
                                              ...
                                              <button
                                                className="px-2 sm:px-3 py-1 sm:py-1.5 text-xs sm:text-sm rounded bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-200 cursor-not-allowed whitespace-nowrap"
                                                disabled
                                    ...
                                    <p className="mt-2 text-xs sm:text-sm text-gray-500 dark:text-gray-400">Aucun contenu pour ce module.</p>
                                  )}
                                </div>
                                  ...
                                  <div className="flex-shrink-0 w-full lg:w-auto">
                                    <button
                                      ...
                                      className={`w-full lg:w-auto flex items-center justify-center gap-2 px-3 sm:px-4 py-2 rounded-lg font-medium text-xs sm:text-sm transition-all ${
                                        isCompleted
                                          ? 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-200 hover:bg-green-200 dark:hover:bg-green-900/50 border border-green-300 dark:border-green-700'
                                          : 'bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-200 hover:bg-blue-200 dark:hover:bg-blue-900/50 border border-blue-300 dark:border-blue-700'
                                      }`}
                  ...
                  <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-gray-200 dark:border-gray-700">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 text-xs sm:text-sm text-gray-500 dark:text-gray-400">
                      <div className="p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                        <span className="font-medium block mb-1 text-gray-700 dark:text-gray-300">Durée:</span>
                        <span>{formation.duration ? formation.duration : "Non spécifiée"}</span>
                      </div>
                      <div className="p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                        <span className="font-medium block mb-1 text-gray-700 dark:text-gray-300">Format:</span>
                        <span>En ligne</span>
                      </div>
                      <div className="p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                        <span className="font-medium block mb-1 text-gray-700 dark:text-gray-300">Langue:</span>
                        <span>{formation.language ? formation.language : "Non spécifiée"}</span>
                      </div>
                      <div className="p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                        <span className="font-medium block mb-1 text-gray-700 dark:text-gray-300">Support:</span>
                        <span>24/7</span>
                      </div>
                    </div>
                  </div>
