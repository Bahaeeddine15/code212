...
export default function StudentDashboard() {
  ...
  // Stats data with new color palette
  const stats = [
    {
      title: "Certificats",
      value: "12",
          ...
          <Card className="border-l-4 border-l-[#3a2b6c] bg-white">
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  <Avatar className="h-20 w-20 border-2 border-[#081f44]">
                    <AvatarImage src="/placeholder.svg?height=80&width=80" />
                    <AvatarFallback className="text-xl bg-[#f4f4f4] text-[#3a2b6c]">
                      {user.name
                        .split(" ")
                        .map((n) => n[0])
                        .join("")}
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-[#081f44]">{user.name}</h3>
                    <p className="text-gray-600">{user.email}</p>
                    <p className="text-sm text-gray-500">{user.studentId}</p>
                  </div>
                </div>
                <Button className="text-white bg-[#3a2b6c] hover:bg-[#c5027f]/90">Modifier le profil</Button>
              </div>
            </CardContent>
          </Card>
        )
      ...
      case "formations":
        return (
          <Card className="border-l-4 border-l-[#3a2b6c] bg-white ">
            ...
            <CardContent>
              <p className="text-gray-600">Liste des formations à venir...</p>
            </CardContent>
          </Card>
        )
  ...
  return (
    <div className="flex min-h-screen bg-[#f4f4f4] p-4">
      {/* Sidebar */}
      <aside className="w-64 bg-[#3a2b6c] text-white flex flex-col h-[calc(100vh-2rem)] fixed left-4 top-4 rounded-2xl shadow-2xl">
        {/* Logo/Header */}
        <div className="p-6 border-b border-[#452ff5]/20">
          <div className="flex items-center space-x-3">
            <div className="bg-[#3a2b6c] p-2 rounded-lg">
